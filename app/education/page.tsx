        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-flex items-center justify-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 flex items-center justify-center">
            ...
            <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
              My academic journey, technical expertise, and professional certifications
            </p>
            <div className="w-20 h-1 bg-gradient-to-r from-purple-400 to-blue-400 rounded-full mx-auto mt-6 opacity-60"></div>
          </div>
            ...
            <div className="relative bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-10 border border-gray-200/50 dark:border-white/10 shadow-xl transition-all duration-500 hover:shadow-2xl hover:scale-[1.01]">
              <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-10">
                ...
                <div className="flex-shrink-0 relative">
                  ...
                  {/* Status Badge */}
                  <div className="absolute -bottom-3 -right-3 bg-gradient-to-r from-green-400 to-emerald-500 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-lg">
                    Ongoing
                  </div>
                </div>
                ...
                <div className="flex-1 text-center lg:text-left">
                  <div className="flex items-center justify-center lg:justify-start gap-3 mb-3">
                    <FaUniversity className="w-5 h-5 text-purple-500" />
